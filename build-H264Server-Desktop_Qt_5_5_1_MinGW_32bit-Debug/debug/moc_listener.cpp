...
QT_MOC_LITERAL(1, 9, 7), // "addDest"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "QHostAddress"
QT_MOC_LITERAL(4, 31, 4), // "addr"
QT_MOC_LITERAL(5, 36, 4), // "port"
QT_MOC_LITERAL(6, 41, 7), // "delDest"
QT_MOC_LITERAL(7, 49, 13), // "readDatagrams"
QT_MOC_LITERAL(8, 63, 13) // "checkEndState"

    },
    "Listener\0addDest\0\0QHostAddress\0addr\0"
    "port\0delDest\0readDatagrams\0checkEndState"
};
...
void Listener::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Listener::*_t)(QHostAddress , quint16 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Listener::addDest)) {
                *result = 0;
            }
        }
        {
            typedef void (Listener::*_t)(QHostAddress , quint16 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Listener::delDest)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void Listener::addDest(QHostAddress _t1, quint16 _t2)
{
...
// SIGNAL 1
void Listener::delDest(QHostAddress _t1, quint16 _t2)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
